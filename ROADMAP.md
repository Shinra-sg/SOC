...
**Задачи**:
- [ ] Создать генератор синтетических логов
- [ ] Подготовить sample security events (100-1000 записей)
- [ ] Создать список известных IoC (malicious IPs, domains)
- [ ] Подготовить список CVE (из NVD)
- [ ] Создать mock assets (серверы, workstations)

**Результат**: Файлы в `data/samples/`
...
```
PHASE 1: [▓▓] 2/3   (67%) - Почти завершено
...
**Следующий этап**: PHASE 1.3 - Подготовка тестовых данных

**Следующие шаги**:
1. Создать генератор синтетических логов
2. Подготовить sample security events
3. Создать списки IoC и CVE
4. Создать mock assets
